...
export const APP_REGISTRY = [
  ...
  { name: 'Video Player',   slug: 'video-player',   icon_name: 'Video',      description: 'Play videos from your drive storage with full controls', category: 'Media' },
  { name: 'Audio Player',   slug: 'audio-player',   icon_name: 'Headphones', description: 'Listen to music and audio files from your drive', category: 'Media' },
